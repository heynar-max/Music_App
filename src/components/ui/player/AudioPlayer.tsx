...
export const Player = () => {
    ...
    useEffect(() => {
        ...
        const res = await fetch(`/api/favorite-song/${currentMusic.song.id}`);
    ...
    const handleFavorite = async () => {
        ...
        if (!isFavorite) {
        await fetch(`/api/favorite-song/${currentMusic.song.id}`, { method: "POST" });
        setIsFavorite(true);
        } else {
        await fetch(`/api/favorite-song/${currentMusic.song.id}`, { method: "DELETE" });
        setIsFavorite(false);
        }
    };
